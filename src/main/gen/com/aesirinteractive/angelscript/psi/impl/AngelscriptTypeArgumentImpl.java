...
public class AngelscriptTypeArgumentImpl extends ASTWrapperPsiElement implements AngelscriptTypeArgument {

  public AngelscriptTypeArgumentImpl(@NotNull ASTNode node) {
    super(node);
  }
