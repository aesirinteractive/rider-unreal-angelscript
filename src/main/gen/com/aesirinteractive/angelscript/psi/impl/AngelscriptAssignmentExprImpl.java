...
public class AngelscriptAssignmentExprImpl extends AngelscriptExprImpl implements AngelscriptAssignmentExpr {

  public AngelscriptAssignmentExprImpl(@NotNull ASTNode node) {
    super(node);
  }
