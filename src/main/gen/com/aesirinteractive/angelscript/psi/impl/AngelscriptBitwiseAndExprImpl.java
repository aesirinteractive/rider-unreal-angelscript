...
public class AngelscriptBitwiseAndExprImpl extends AngelscriptExprImpl implements AngelscriptBitwiseAndExpr {

  public AngelscriptBitwiseAndExprImpl(@NotNull ASTNode node) {
    super(node);
  }
