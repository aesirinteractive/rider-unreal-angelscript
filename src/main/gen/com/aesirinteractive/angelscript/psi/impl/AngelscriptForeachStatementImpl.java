...
public class AngelscriptForeachStatementImpl extends ASTWrapperPsiElement implements AngelscriptForeachStatement {

  public AngelscriptForeachStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
