...
public class AngelscriptStringConcatExprImpl extends AngelscriptExprImpl implements AngelscriptStringConcatExpr {

  public AngelscriptStringConcatExprImpl(@NotNull ASTNode node) {
    super(node);
  }
