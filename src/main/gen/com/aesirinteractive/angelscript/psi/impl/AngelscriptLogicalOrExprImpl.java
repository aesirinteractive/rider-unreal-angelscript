...
public class AngelscriptLogicalOrExprImpl extends AngelscriptExprImpl implements AngelscriptLogicalOrExpr {

  public AngelscriptLogicalOrExprImpl(@NotNull ASTNode node) {
    super(node);
  }
