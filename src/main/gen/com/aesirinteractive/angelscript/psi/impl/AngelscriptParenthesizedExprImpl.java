...
public class AngelscriptParenthesizedExprImpl extends AngelscriptExprImpl implements AngelscriptParenthesizedExpr {

  public AngelscriptParenthesizedExprImpl(@NotNull ASTNode node) {
    super(node);
  }
