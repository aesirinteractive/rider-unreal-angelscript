...
public class AngelscriptExpressionStatementImpl extends ASTWrapperPsiElement implements AngelscriptExpressionStatement {

  public AngelscriptExpressionStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
