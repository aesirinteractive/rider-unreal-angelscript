...
public class AngelscriptElseClauseImpl extends ASTWrapperPsiElement implements AngelscriptElseClause {

  public AngelscriptElseClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
