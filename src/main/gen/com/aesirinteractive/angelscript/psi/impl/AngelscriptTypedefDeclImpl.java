...
public class AngelscriptTypedefDeclImpl extends AngelscriptNamedElementImpl implements AngelscriptTypedefDecl {

  public AngelscriptTypedefDeclImpl(@NotNull ASTNode node) {
    super(node);
  }
