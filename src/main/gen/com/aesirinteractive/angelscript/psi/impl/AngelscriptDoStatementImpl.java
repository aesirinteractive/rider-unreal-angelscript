...
public class AngelscriptDoStatementImpl extends ASTWrapperPsiElement implements AngelscriptDoStatement {

  public AngelscriptDoStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
