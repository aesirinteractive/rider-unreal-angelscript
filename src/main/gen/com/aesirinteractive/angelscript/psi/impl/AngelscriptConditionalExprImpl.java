...
public class AngelscriptConditionalExprImpl extends AngelscriptExprImpl implements AngelscriptConditionalExpr {

  public AngelscriptConditionalExprImpl(@NotNull ASTNode node) {
    super(node);
  }
