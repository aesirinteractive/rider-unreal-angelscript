...
public class AngelscriptEnumVariantImpl extends AngelscriptNamedElementImpl implements AngelscriptEnumVariant {

  public AngelscriptEnumVariantImpl(@NotNull ASTNode node) {
    super(node);
  }
