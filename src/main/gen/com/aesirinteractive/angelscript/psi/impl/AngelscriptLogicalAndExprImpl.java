...
public class AngelscriptLogicalAndExprImpl extends AngelscriptExprImpl implements AngelscriptLogicalAndExpr {

  public AngelscriptLogicalAndExprImpl(@NotNull ASTNode node) {
    super(node);
  }
