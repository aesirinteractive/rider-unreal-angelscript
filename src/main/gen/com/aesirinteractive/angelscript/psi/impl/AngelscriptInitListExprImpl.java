...
public class AngelscriptInitListExprImpl extends AngelscriptExprImpl implements AngelscriptInitListExpr {

  public AngelscriptInitListExprImpl(@NotNull ASTNode node) {
    super(node);
  }
