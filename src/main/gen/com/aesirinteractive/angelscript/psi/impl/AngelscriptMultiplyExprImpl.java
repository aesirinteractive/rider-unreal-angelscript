...
public class AngelscriptMultiplyExprImpl extends AngelscriptExprImpl implements AngelscriptMultiplyExpr {

  public AngelscriptMultiplyExprImpl(@NotNull ASTNode node) {
    super(node);
  }
