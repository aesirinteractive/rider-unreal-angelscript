...
public class AngelscriptWhileStatementImpl extends ASTWrapperPsiElement implements AngelscriptWhileStatement {

  public AngelscriptWhileStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
