...
public class AngelscriptSwitchStatementImpl extends ASTWrapperPsiElement implements AngelscriptSwitchStatement {

  public AngelscriptSwitchStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public AngelscriptCompoundStatement getCompoundStatement() {
    return findNotNullChildByClass(AngelscriptCompoundStatement.class);
  }
