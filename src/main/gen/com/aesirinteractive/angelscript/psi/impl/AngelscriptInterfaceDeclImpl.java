...
public class AngelscriptInterfaceDeclImpl extends AngelscriptNamedElementImpl implements AngelscriptInterfaceDecl {

  public AngelscriptInterfaceDeclImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public AngelscriptUInterfaceDecl getUInterfaceDecl() {
    return findChildByClass(AngelscriptUInterfaceDecl.class);
  }
