...
public class AngelscriptInclusiveOrExprImpl extends AngelscriptExprImpl implements AngelscriptInclusiveOrExpr {

  public AngelscriptInclusiveOrExprImpl(@NotNull ASTNode node) {
    super(node);
  }
