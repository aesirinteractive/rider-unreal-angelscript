...
public class AngelscriptBreakStatementImpl extends ASTWrapperPsiElement implements AngelscriptBreakStatement {

  public AngelscriptBreakStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
